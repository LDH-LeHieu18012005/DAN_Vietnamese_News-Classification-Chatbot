...
Toàn bộ dataset đã được public tại:

[![Kaggle Dataset](https://img.shields.io/badge/Dataset-Kaggle-blue)](https://www.kaggle.com/datasets/ldhhieu18/final-data)

🔗 https://www.kaggle.com/datasets/ldhhieu18/final-data  

> Bao gồm dữ liệu đã crawl, tiền xử lý và chia train/test — sẵn sàng cho huấn luyện và đánh giá.
...
Cả hai mô hình embedding (GloVe, Word2Vec) đều được xây dựng trên tập train:
